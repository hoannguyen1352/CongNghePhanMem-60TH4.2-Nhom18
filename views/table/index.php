    ...
    <div class="col-md-8">
      ...
      <div class="container">
        ...
        foreach ($data as $table) {
          ...
          <?php } else { ?> <a href="./index.php?controller=book&action=show&id=<?php echo $table['id'] ?>" class="m-2 mb-4 pt-4 pb-4 pr-5 pl-5 btn btn-success text-white" style="width:146px;" id="<?php echo $table['id'] ?>" name="table">Bàn <?php echo $table['id'] ?></a>
      <?php }
          echo '</div>';
        }
        echo '</div>';
