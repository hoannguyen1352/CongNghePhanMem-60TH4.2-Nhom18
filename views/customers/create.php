...
?>
    <form action="http://localhost/cnpm/index.php?controller=customers&action=processCreate" method="post">
      ...
      <h1 class="" style="text-align:left"></br>Add customer</h1>
          ...
          <a name="" id="" class="btn btn-secondary" href="index.php?controller=customers&action=index" role="button" style="margin-top:15px">Back</a>
        </div>
        </div>
      </form>